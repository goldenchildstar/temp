$(document).ready(function(){
    ...
    // Animations for panneaux & lapin
    $(window).load(function(){
        $('.google').animate({bottom: "26%"}, 500);
        $('.linkedin').delay(800).animate({bottom: "26%"}, 500);
        $('.lapin').delay(1200).animate({left: "46%"}, 1500);
    });
    ...
    /** Placeholder injection (disabled)
